...
<div class="form-container">
    ...
    <form method="POST">
        ...
        <select name="role" class="form-control" required>
            <option value="Super Admin" <?php echo ($editMode && $adminData['role'] == 'Super Admin') ? 'selected' : ''; ?>>Super Admin</option>
            <option value="Admin" <?php echo ($editMode && $adminData['role'] == 'Admin') ? 'selected' : ''; ?>>Admin</option>
            <option value="Manager" <?php echo ($editMode && $adminData['role'] == 'Manager') ? 'selected' : ''; ?>>Manager</option>
        </select>
