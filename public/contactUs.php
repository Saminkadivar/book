...
?>
<script>
document.title = "Contact Us | Book Heaven";
</script>
    ...
    <div class="row">
        <div class="col-6">
            <a class="text-black text-decoration-none text-break fs-4"
                href="mailto:bookheaven@gmail.com?subject=Contact us"><i class="fas fa-envelope"></i> Email Us -
                bookheaven@gmail.com</a>
        </div>
        <div class="col-6 text-end">
            <a class="text-black text-decoration-none text-break fs-4 text-end" href="tel:+918200026182"><i
                    class="fas fa-phone"></i> Call Us - +918200026182</a>
        </div>
    </div>
</div>
